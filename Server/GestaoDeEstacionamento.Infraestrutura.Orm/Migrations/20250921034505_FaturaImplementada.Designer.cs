...
namespace GestaoDeEstacionamento.Infraestrutura.Orm.Migrations
{
    ...
    [Migration("20250921034505_FaturaImplementada")]
    partial class FaturaImplementada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoDeEstacionamento.Core.Dominio.ModuloFatura.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ZonaVaga")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.HasKey("Id");

                    b.HasIndex("DataHoraSaida");
            ...
            modelBuilder.Entity("RelatorioFinanceiroFaturas", b =>
                {
                    b.HasOne("GestaoDeEstacionamento.Core.Dominio.ModuloFatura.Fatura", null)
                        .WithMany()
