...
namespace GestaoDeEstacionamento.TestsIntegracao.Compartilhado;
...
public abstract class TestFixture
{
    ...
    protected RepositorioRelatorioFinanceiroEmOrm? repositorioRelatorio;
    ...
    public void ConfigurarTestes()
    {
        ...
        repositorioRelatorio = new RepositorioRelatorioFinanceiroEmOrm(dbContext);
        ...
        BuilderSetup.SetCreatePersistenceMethod<RelatorioFinanceiro>(async x => await repositorioRelatorio.CadastrarAsync(x));
        BuilderSetup.SetCreatePersistenceMethod<IList<RelatorioFinanceiro>>(async x => await repositorioRelatorio.CadastrarEntidades(x));
